...
Func_f98a2:
	ld a, [wShadowOAMSprite08Attributes] ; No idea what this one changes
	or $1
	ld [wShadowOAMSprite08Attributes], a ; already good
	ld a, [wShadowOAMSprite14Attributes] ; testing
	or $1
	ld [wShadowOAMSprite14Attributes], a ; already good
	ld a, [wShadowOAMSprite16Attributes]
	or $1
	ld [wShadowOAMSprite16Attributes], a ; already good
	ld a, [wShadowOAMSprite18Attributes]
	or $1
	ld [wShadowOAMSprite18Attributes], a ; already good
	ld a, [wShadowOAMSprite19Attributes]
	or $1
	ld [wShadowOAMSprite19Attributes], a ; already good
	ret
...
Jumptable_f9906:
	dw YellowIntroScene0 ; running pyuku 1
	dw YellowIntroScene1 ; wait last
	dw YellowIntroScene2 ; pyukumuku lunge
	dw YellowIntroScene3 ; wait last
	dw YellowIntroScene4 ; running pyuku 2
	dw YellowIntroScene5 ; wait last
	dw YellowIntroScene6 ; surfing pyuku
	dw YellowIntroScene7 ; wait last
	dw YellowIntroScene8 ; running pyuku 3
	dw YellowIntroScene9 ; wait last
	dw YellowIntroScene10 ; flying pyuku
	dw YellowIntroScene11 ; wait last
	dw YellowIntroScene12 ; pyuku close up
	dw YellowIntroScene13 ; wait last
	dw YellowIntroScene14 ; pyuku innardout
...
YellowIntroScene6: ; Surfing Pyuku
	call YellowIntro_BlankPalsDelay2AndDisableLCD
	ld c, $5
	call UpdateMusicCTimes
	ld a, LOW(rSCY)
...
.expired
	call MaskAllAnimatedObjectStructs
	call YellowIntro_BlankOAMBuffer ; idfk
	ld hl, wTileMap
	ld bc, $50
	ld a, $1
	call Bank3E_FillMemory
	hlcoord 0, 4
	ld bc, CopyVideoDataAlternate ; removing "Alternate" breaks the game
	xor a
	call Bank3E_FillMemory
	hlcoord 0, 14
	ld bc, $50
	...
	call UpdateCGBPal_BGP
	call UpdateCGBPal_OBP0
	lb de, $58, $58 ; sprite placement?
	ld a, $7
	call YellowIntro_SpawnAnimatedObjectAndSavePointer ; the graphic
	call YellowIntro_NextScene
	ld a, $28

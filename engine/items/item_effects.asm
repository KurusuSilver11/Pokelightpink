...
; entries correspond to item ids
	...
	dw ItemUseEvoStone   ; FREEZEWING
	dw ItemUseEvoStone   ; ITEM_HEART_STONE
	dw ItemUseEvoStone   ; ITEM_POISON_STONE
...
.loop
	...
	ld [de], a
	inc de
	inc hl ; "Improve the Pokédex AREA functionality"
	ret ; This and the above line are to make the process more efficient? 
.nextEntry
	inc hl
	inc hl
	dec b

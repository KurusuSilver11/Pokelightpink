...
.FlyOrChargeEffect
	...
	ld [wAnimationType], a
	ld a, STATUS_AFFECTED_ANIM
	call PlayAltAnimation ; was Playmoveanimation
...
HandleCounterLikeMoves:			; new, test; it worked bitch
	ldh a, [hWhoseTurn] ; whose turn
	and a
	; player's turn
;	ld hl, wEnemySelectedMove
...
;	callfar Func_78e98
;	ret ; Extreme yellow doesn't have these apparently.

LoadBackSpriteUnzoomed2:
	ld a, $66
	ld de, vBackPic
	push de

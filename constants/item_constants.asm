...
DEF SAFARI_ROCK EQU CASCADEBADGE ; overload
	...
	const SECRET_KEY    ; $2B
	const LINKING_CORD  ; $2C ; used to be ITEM_2C
	const BIKE_VOUCHER  ; $2D
	const X_ACCURACY    ; $2E
	const LEAF_STONE    ; $2F
	const CARD_KEY      ; $30
	const NUGGET        ; $31
	const BETA_SHARD    ; $32 ; used to be ITEM_32
	const POKE_DOLL     ; $33
	const FULL_HEAL     ; $34
	const REVIVE        ; $35
	const MAX_REVIVE    ; $36
	...
	const ELIXER        ; $52
	const MAX_ELIXER    ; $53
	const FROZENWING    ; lol
	const ITEM_HEART_STONE ; Espeon stone
	const ITEM_POISON_STONE ; Umbreon stone
...
DEF TM01 EQU const_value
	...
	add_tm LIGHT_SCREEN ; $FC
	add_tm ICE_PUNCH    ; $FD
	add_tm THUNDERPUNCH ; $FE
	add_tm FIRE_PUNCH   ; $FF
	add_tm ICE_FANG     ; $G0
	add_tm THUNDER_FANG ; $G1
	add_tm FIRE_FANG    ; $G2
	add_tm SHADOW_CLAW  ; $G3
	add_tm MORNING_SUN  ; $G4
	add_tm MOONLIGHT    ; $G5
	add_tm SYNTHESIS    ; $G6
	add_tm ROOST        ; $G7
	add_tm DRILL_RUN    ; $G8
	add_tm AIR_CUTTER   ; $G9
	add_tm SCORCHSANDS  ; $GA
	add_tm SHADOWBALL   ; $GB
	add_tm CRUNCH       ; $GC
	add_tm OUTRAGE      ; $GD
	add_tm IRON_TAIL    ; $GE
	add_tm GIGA_DRAIN   ; $GF
	add_tm WILD_CHARGE  ; $H0
	add_tm SLUDGEBOMB   ; $H1
	add_tm HEAT_WAVE    ; $H2
	add_tm LEECH_LIFE   ; $H3
	add_tm LOW_KICK     ; $H4
	add_tm HURRICANE    ; $H5
	add_tm MIRROR_COAT  ; $H6
	add_tm AGILITY      ; $H7
ASSERT NUM_TMS == const_value - TM01, "NUM_TMS ({d:NUM_TMS}) does not match the number of add_tm definitions"

DEF NUM_TM_HM EQU NUM_TMS + NUM_HMS

; 79 TMs + 5 HMs = 84 learnable TM/HM flags per Pokémon.
; These fit in 10 bytes, with one? unused bit left over.

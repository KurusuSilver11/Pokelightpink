...
; - MonsterPalettes (see data/pokemon/palettes.asm)
	...
	const DEX_ZILLGOA    ; 153
	const DEX_SUBFEAROW  ; 154
	const DEX_CLUSTERTON ; 155
	const DEX_ZAPPURU    ; 156
	const DEX_PINKACHU   ; 157
	const DEX_EKSING     ; 158
	const DEX_EEVEE_S    ; 159
	const DEX_LEAFY      ; 160
	const DEX_EIFIE      ; 161
	const DEX_BLACKY     ; 162

MonPartyData:
	...
	nybble ICON_MON       ; Mew
	nybble ICON_PIKACHU   ; Pyukumuku
	nybble ICON_MON       ; Zillgoa
	nybble ICON_BIRD      ; Fearow
	nybble ICON_BALL      ; Clusterton
	nybble ICON_FAIRY     ; Zappuru
	nybble ICON_FAIRY     ; Pinkachu
	nybble ICON_MON       ; Eksing/Ekushingu
	nybble ICON_QUADRUPED ; EeveeS
	nybble ICON_QUADRUPED ; Riifi
	nybble ICON_QUADRUPED ; Eifie
	nybble ICON_QUADRUPED ; Blacky

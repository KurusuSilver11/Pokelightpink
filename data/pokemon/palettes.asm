MonsterPalettes:
	...
	db PAL_MEWTWOMON ; MEWTWO
	db PAL_MEWTWOMON ; MEW
	db PAL_MEWMON    ; PYUKUMUKU
	db PAL_GREENMON  ; ZILLGOA
	db PAL_CYANMON   ; SUBFEAROW
	db PAL_GRAYMON   ; CLUSTERTON
	db PAL_BLUEMON   ; ZAPPURU
	db PAL_PURPLEMON ; PINKACHU
	db PAL_BETAPURPLEMON ; MON_EKSING
	db PAL_BETAGRAYMON   ; MON_EEVEE
	db PAL_BETAGREENMON  ; MON_LEAFY
	db PAL_BETAYELLOWMON ; MON_EIFIE
	db PAL_BETAGRAYMON   ; MON_BLACKY

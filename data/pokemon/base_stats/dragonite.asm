	...
	tmhm RAZOR_WIND,   TOXIC,        HORN_DRILL,   BODY_SLAM,    TAKE_DOWN,    \
	     ...
	     SURF,         STRENGTH,     LOW_KICK,     OUTRAGE,      EARTHQUAKE,   \
	     AIR_CUTTER,   FIRE_PUNCH,   ICE_PUNCH,    THUNDERPUNCH, FLAMETHROWER, \
	     IRON_TAIL,    ROOST,        ROCK_SLIDE,   HEAT_WAVE,    HURRICANE,    \
	     LIGHT_SCREEN, AGILITY,      FLY
	; end

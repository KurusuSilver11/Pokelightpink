...
_SubfearowDexEntry::
	text "This #MON"
	next "has been frozen"
	next "entirely inside."

	page "Its FREEZEWING"
	next "can encase one"
	next "in ice instantly"
	dex

_ClustertonDexEntry::
	text "Magnemite from ???"
	next "tried evolving"
	next "with normal ones."

	page "It went poorly,"
	next "and now they're"
	next "all stuck"
	dex

_ZappuruDexEntry::
	text "Chews toxic barbs,"
	next "among other stuff."
	next " "

	page "If unchecked, can"
	next "make some #MON"
	next "endangered"
	dex
...
_PinkachuDexEntry::
	text "A total menace"
	next "to society with"
	next "shiny pink fur."

	page "He enjoys messing"
	next "with everyone and"
	next "anything"
	dex

_BetaDexEntry:: ; Spaceworld mons. Currently under investigation
	text " "
	next " "
	next " "

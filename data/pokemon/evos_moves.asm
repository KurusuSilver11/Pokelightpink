...
; Evolutions
	db 0
; Learnset ; The order is add 3, then 2, then 3, then 4, then 3, then 6; I think you get it
	db 24, BIND
	db 27, ABSORB
	db 29, VINE_WHIP
	db 32, POISONPOWDER
...
EeveeSEvosMoves:
; Evolutions
	db EVOLVE_ITEM, LEAF_STONE, 1, MON_LEAFY
	db EVOLVE_ITEM, ITEM_HEART_STONE, 1, MON_EIFIE
	db EVOLVE_ITEM, ITEM_POISON_STONE, 1, MON_BLACKY
	db 0
; Learnset
;	db  1, TACKLE
	db  7, SAND_ATTACK
...
FearowEvosMoves:
; Evolutions
	db EVOLVE_ITEM, FROZENWING, 1, SUBFEAROW
	db 0
; Learnset
	db 9, LEER
	db 15, FURY_ATTACK
...
; Learnset
	...
	db 28, ABSORB
	db 35, RAZOR_LEAF
;	db 36, LEAF_BLADE ; just for stream
	db 42, GROWTH
	db 49, MORNING_SUN
	db 56, WRAP
	db 63, SOLARBEAM
...
; Learnset
	...
	db 28, CONFUSION
	db 35, BITE
;	db 36, PSYCHIC_M ; just for stream
	db 42, AGILITY
	db 49, REFLECT
	db 56, LIGHT_SCREEN
	db 63, PSYCHIC_M
...
; Learnset
	...
	db 28, SMOG
	db 35, ACID
;	db 36, SLUDGEBOMB ; just for stream
	db 42, ACID_ARMOR
	db 49, SLUDGE
	db 56, SMOKESCREEN
	db 63, SLUDGEBOMB
...
GolbatEvosMoves:
; Evolutions
	db EVOLVE_ITEM, BETA_SHARD, 1, MON_EKSING
	db 0
; Learnset
	db 10, SUPERSONIC
	db 15, BITE

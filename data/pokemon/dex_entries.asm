...
MissingNoDexEntry:
	...
	db 10 ; 1.0 m
	dw 100 ; 10.0 kg
	db "Why are we here@" ; コメント作成中 (Comment to be written) ; used to be "コメント　さくせいちゅう"

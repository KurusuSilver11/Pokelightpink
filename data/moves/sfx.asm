MoveSoundTable:
	...
	db SFX_BATTLE_0D,          $20, $40 ; INNARDOUT
	db SFX_BATTLE_2A,          $20, $20 ; SHADOWBALL
	db SFX_BATTLE_1E,          $01, $ff ; CRUNCH
	db SFX_BATTLE_25,          $00, $40 ; EXTREMESPD
	db SFX_BATTLE_22,          $f0, $80 ; OUTRAGE
	db SFX_BATTLE_24,          $40, $c0 ; GIGA_DRAIN
	db SFX_NOT_VERY_EFFECTIVE, $00, $80 ; IRON_TAIL
	db SFX_BATTLE_0B,          $00, $40 ; MACH_PUNCH
	db SFX_BATTLE_21,          $12, $10 ; SLACK_OFF
	db SFX_BATTLE_2A,          $f0, $80 ; SLUDGEBOMB
	db SFX_BATTLE_0E,          $20, $20 ; STEEL_WING
	db SFX_NOT_VERY_EFFECTIVE, $2f, $80 ; AQUACUTTER
	db SFX_BATTLE_13,          $0f, $e0 ; DRILL_RUN
	db SFX_PSYCHIC_M,          $20, $20 ; FLASHCANNON
	db SFX_NOT_VERY_EFFECTIVE, $20, $20 ; CROSSPOISON
	db SFX_NOT_VERY_EFFECTIVE, $10, $a0 ; AIR_CUTTER
	db SFX_BATTLE_19,          $0f, $e0 ; SCORCHSANDS
	db SFX_BATTLE_2F,          $00, $a0 ; WILD_CHARGE
	db SFX_NOT_VERY_EFFECTIVE, $f0, $80 ; POISON_TAIL
	db SFX_BATTLE_1E,          $00, $80 ; ICE_FANG
	db SFX_BATTLE_1E,          $00, $80 ; FIRE_FANG
	db SFX_BATTLE_1E,          $00, $80 ; THUNDER_FANG
	db SFX_BATTLE_22,          $1f, $20 ; RAGING_FURY
	db SFX_BATTLE_36,          $00, $80 ; HYDROCANNON
	db SFX_BATTLE_36,          $00, $80 ; BLASTBURN
	db SFX_BATTLE_36,          $00, $80 ; FRENZYPLANT
	db SFX_BATTLE_33,          $00, $80 ; MORNING_SUN
	db SFX_BATTLE_33,          $00, $80 ; MOONLIGHT
	db SFX_BATTLE_33,          $00, $80 ; SYNTHESIS
	db SFX_BATTLE_33,          $00, $80 ; ROOST
	db SFX_NOT_VERY_EFFECTIVE, $20, $20 ; SHADOW_CLAW
	db SFX_BATTLE_25,          $40, $80 ; ICE_SHARD
	db SFX_DOUBLESLAP,         $10, $60 ; FLARE_BLITZ
	db SFX_BATTLE_2E,          $11, $e0 ; CHARGE
	db SFX_BATTLE_2C,          $10, $40 ; DIVE
	db SFX_BATTLE_0C,          $0f, $e0 ; CROSS_CHOP
	db SFX_BATTLE_12,          $0f, $e0 ; HURRICANE
	db SFX_BATTLE_26,          $20, $c0 ; VOLT_TACKLE
	db SFX_BATTLE_12,          $0f, $e0 ; POWER_WHIP
	db SFX_BATTLE_29,          $00, $80 ; HEAT_WAVE
	db SFX_BATTLE_29,          $f0, $20 ; FREEZEWING
	db SFX_NOT_VERY_EFFECTIVE, $20, $e0 ; LEAF_BLADE
	db SFX_BATTLE_36,          $01, $80 ; ATOMBREATH
	db SFX_SUPER_EFFECTIVE,    $f0, $10 ; MIRROR_COAT
	db SFX_FAINT_FALL,         $80, $04 ; QUIVERDANCE
	db SFX_SUPER_EFFECTIVE,    $20, $e0 ; WOOD_HAMMER
	db SFX_BATTLE_2A,          $20, $20 ; GUNK_SHOT
	db SFX_SUPER_EFFECTIVE,    $00, $10 ; PAZ_YPPIZ
	db SFX_PSYCHIC_M,          $00, $80 ; PSYSTRIKE
	db SFX_PSYCHIC_M,          $20, $20 ; FLASHCANNON
	db SFX_BATTLE_26,          $f0, $20 ; WORK_UP
	db SFX_NOT_VERY_EFFECTIVE, $01, $ff ; X_SCISSOR
	db SFX_NOT_VERY_EFFECTIVE, $01, $ff ; NIGHT_SLASH
	db SFX_NOT_VERY_EFFECTIVE, $f0, $80 ; PIERCINHEART

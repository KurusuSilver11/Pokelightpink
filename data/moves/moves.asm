...
; Characteristics of each move.
	...
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        85, BUG,          100, 30
	...
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,        130, GROUND,        85, 20
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,        100, GROUND,        90, 10
	...
	move SLUDGEBOMB,   POISON_SIDE_EFFECT2,         90, POISON,       100, 10
	move STEEL_WING,   NO_ADDITIONAL_EFFECT,        70, STEEL,         90, 25
	move AQUACUTTER,   NO_ADDITIONAL_EFFECT,        70, WATER,        100, 20
	move DRILL_RUN,    NO_ADDITIONAL_EFFECT,        80, GROUND,        95, 10
	move FLASHCANNON,  SPECIAL_DOWN_SIDE_EFFECT,    80, STEEL,        100, 10
	move CROSSPOISON,  NO_ADDITIONAL_EFFECT,        70, POISON,       100, 20
	move AIR_CUTTER,   NO_ADDITIONAL_EFFECT,        60, FLYING,        95, 25
	move SCORCHSANDS,  BURN_SIDE_EFFECT2,           70, GROUND,       100, 10
	...
	move RAGING_FURY,  THRASH_PETAL_DANCE_EFFECT,  120, FIRE,         100, 10
	move HYDROCANNON,  HYPER_BEAM_EFFECT,          150, WATER,         90,  5
	move BLASTBURN,    HYPER_BEAM_EFFECT,          150, FIRE,          90,  5
	move FRENZYPLANT,  HYPER_BEAM_EFFECT,          150, GRASS,         90,  5
	...
	move CHARGE,       SPECIAL_UP1_EFFECT,           0, ELECTRIC,     100, 20
	move DIVE,         CHARGE_EFFECT,              100, WATER,        100, 10
	move CROSS_CHOP,   NO_ADDITIONAL_EFFECT,       100, FIGHTING,      80,  5
	move HURRICANE,    CONFUSION_SIDE_EFFECT,      120, FLYING,        90, 10
	...
	move FREEZEWING,   FREEZE_SIDE_EFFECT2,        110, ICE,           85,  5
	move LEAF_BLADE,   NO_ADDITIONAL_EFFECT,        90, GRASS,        100, 15
	move ATOM_BREATH,  HYPER_BEAM_EFFECT,          150, DRAGON,        90,  5
	move MIRROR_COAT,  NO_ADDITIONAL_EFFECT,         1, PSYCHIC_TYPE, 100, 20
	move QUIVERDANCE,  SPECIAL_SPEED_UP1_EFFECT,     0, BUG,          100, 20
	...
	move MULTI_FLASH,  SPECIAL_DOWN_SIDE_EFFECT,   120, STEEL,         85, 10
	move WORK_UP,      ATTACK_SPECIAL_UP1_EFFECT,    0, NORMAL,       100, 30
	move X_SCISSOR,    NO_ADDITIONAL_EFFECT,        80, BUG,          100, 15
	move NIGHT_SLASH,  NO_ADDITIONAL_EFFECT,        70, DARK,         100, 15
	move PIERCINHEART, POISON_SIDE_EFFECT2,        100, POISON,       100, 10
	move ACID_SPRAY,   SPECIAL_DOWN2_EFFECT,        40, POISON,       100, 20
